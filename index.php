    ...
    <script>
      (function() {
        ...
        function flot_graph_short (array)
        {
            ...
            var dataset2 = [
                {
                    label: "Total Count", data: data2, color: "<?php echo $color; ?>"
                }
            ];
            var options = {
                series: {
        ...
        function flot_graph_long (array)
        {
            ...
            var dataset = [
                {
                    label: "Total Count", data: data, color: "<?php echo $color; ?>"
                }
            ];
            var options = {
                series: {
        ...
        /*if (access_token && (state == null || state !== storedState)) {
          ...
          document.getElementById('login-button').addEventListener('click', function() {
            ...
            //var redirect_uri = 'http://project3/visual/'; // Your redirect uri
	...
	<body>
		<header>
			...
			<hr>
				...
				<div id="placeholder" style="width:930px;height:300px;margin: 0 auto"></div>
				<script type="text/javascript"></script>
				
				<br style="clear:left;"/>
                <hr>
                <h2>Short Term (Last 4 Weeks)</h2>
                <div id="placeholder2" style="width:930px;height:300px;margin: 0 auto"></div>
				<script type="text/javascript"></script>
...
<hr>
	...
	<form action = # method = "POST">
		...
		echo "<center><target=\"_blank\"> <button id = \"tts-button\" class = \"button\" style = \"width:100%\">Convert this page to audio</button></a> 
		<div class = \"recrow\">
		<div class = \"reccolumn\">
		<target=\"_blank\"> <button id = \"tts-pause\" class = \"button\" style = \"width:100%\">Pause</button>
		</div>
		<div class = \"reccolumn\">
		<target=\"_blank\"> <button id = \"tts-stop\" class = \"button\" style = \"width:100%\">Stop</button>
		</div>
		</div>
		</center";
		}
